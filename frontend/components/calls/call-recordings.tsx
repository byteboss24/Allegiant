  ...
  return (
    <div className="fixed inset-0 min-h-screen w-full bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-background dark:via-background dark:to-blue-950 flex items-center justify-center">
      <div className="container mx-auto px-4 py-8 mt-[80px]">
        <div className="shadow-xl rounded-2xl border border-blue-100 dark:border-blue-900 bg-white/90 dark:bg-background/80 backdrop-blur">
          ...
          <div className="flex-1 p-0 sm:p-6 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
              <div
                ...
                className="md:col-span-2 h-full overflow-y-auto rounded-xl bg-white/70 shadow-inner border border-gray-100"
              >
                <CallList
